...
<head>
  ...
  <title>Pescados tienda gon</title>
...
<body class="cuerpo">
  ...
  <div class="contenedor">
    ...
    // Selecciona todos los registros de la tabla "pescado"
    $result = mysqli_query($conn, "SELECT * FROM pescado");
    ...
    // Recorre los registros de la tabla "pescados"
